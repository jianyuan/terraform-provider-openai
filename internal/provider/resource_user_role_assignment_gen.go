...
func (r *UserRoleAssignmentResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	modelInstance, err := r.clientV2.Admin.Organization.Users.Roles.New(ctx, data.UserId.ValueString(), *body)
	if err != nil {
...
func (r *UserRoleAssignmentResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	modelInstance, err := r.clientV2.Admin.Organization.Users.Roles.Get(ctx, data.UserId.ValueString(), data.RoleId.ValueString())
	if err != nil {
...
func (r *UserRoleAssignmentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.clientV2.Admin.Organization.Users.Roles.Delete(ctx, data.UserId.ValueString(), data.RoleId.ValueString())
	if err != nil {
