...
func (m *ProjectSpendLimitDataSourceModel) Fill(ctx context.Context, data apiclient.ProjectSpendLimitResource) diag.Diagnostics {
	...
	var enforcement ProjectSpendLimitDataSourceModelEnforcement
