...
func (r *GroupRoleAssignmentResource) getCreateJSONRequestBody(ctx context.Context, data GroupRoleAssignmentResourceModel) (*openai.AdminOrganizationGroupRoleNewParams, diag.Diagnostics) {
