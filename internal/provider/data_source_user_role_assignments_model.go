...
func (m *UserRoleAssignmentsDataSourceModel) Fill(ctx context.Context, roles []openai.AdminOrganizationUserRoleListResponse) diag.Diagnostics {
	m.Roles = supertypes.NewSetNestedObjectValueOfValueSlice(ctx, lo.Map(roles, func(role openai.AdminOrganizationUserRoleListResponse, _ int) UserRoleAssignmentsDataSourceModelRolesItem {
		return UserRoleAssignmentsDataSourceModelRolesItem{
